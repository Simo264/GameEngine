...
namespace Renderer
{
	 ...
	 */
	void DrawArrays(uint32_t mode, const VertexArray& vertexArray, i32 first = 0);
	 ...
	 */
	void DrawArraysInstanced(uint32_t mode, const VertexArray& vertexArray, i32 nInstances, i32 first = 0);

	/**
	 * @brief
	 * Render primitives from array data. See https://registry.khronos.org/OpenGL-Refpages/gl4/html/glDrawElements.xhtml
	 */
	void DrawElements(u32 mode, const VertexArray& vertexArray, i32 offset = 0);
	...
	/**
		...
		*/
	void DrawElementsInstanced(uint32_t mode, const VertexArray& vertexArray, i32 nInstances, i32 offset = 0);
}